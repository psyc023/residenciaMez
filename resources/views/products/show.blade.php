    ...
    <div class="container py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div>
                ...
                <div class="-mt-10 text-green-900">
            ...
            <div>
                <h1 class="text-xl font-bold text-green-900">{{$product->name}}</h1>

                <div class="flex">
                    <p class="text-trueGray-700">Marca: <a class="underline capitalize hover:text-lime-500" href="">{{ $product->brand->name }}</a></p>
                    <p class="text-trueGray-700 mx-6">5 <i class="fas fa-star text-sm text-yellow-400"></i></p>
                    <a class="text-green-900 hover:text-lime-500 underline" href="">39 reseñas</a>
                </div>
